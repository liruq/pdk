...
public class ParamUtils {
    ...
    public static String getEscapeHTMLParameter(HttpServletRequest request,//��д�ӱ���ȡ���ַ�����HTML����滻Ϊ��Ӧ��HTML��ǵķ�����
                                                String paramName) {
        return nullToString(StringUtils.escapeHTMLTags(ParamUtils.getParameter(
            request, paramName, true)));
    }
    public static String getParameter(HttpServletRequest request,//��д�Զ�ȡ�ı���Ϣ�󣬶��ڿյĻ�û��ֵ�ñ���Ϣ����Ĭ��ֵ
...
//�޸�ʹ�õķ���
    public static String getRequestString(HttpServletRequest request,String s){	//��ҪΪ�˵���ǰ�淽��
...
//���ʹ�õķ���
    public static String getRequestString(Request request, String s) {	//��д��request��Ϣ���д���ķ���
        s=nullToString(s).trim();
        s=ParamUtils.getEscapeHTMLParameter(request, s);
        //ת��
       // s=StringUtils.toChinese(s);
    ...
    public static String getSqlString(String s){//��SQL�ַ������д���ķ���
    ...
    public static int getIntParameter(Request request, String s) {//���������е���Ϣ���кϷ��Ե���֤�����Ϸ��Ļ����Ĭ��ֵ
        int defaultNum=0;
