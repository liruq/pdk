...
public final class  FinalConstants {
	public static int STEP = 15; // ÿҳ��ʾ��������
	public static final int STATUS_USER = 0;// ��ͨ�û�
	public static final int STATUS_ADMIN = 1;// ����Ա
	public static final int PAPER_FINALS=0;//��������Ϊ��ĩ����
	public static final int PAPER_REFINALS=1;//��������Ϊ����
	public static final int USER_PASS=0;//ѧ���ɼ�����
	public static final int USER_REPASS=1;//ѧ���ɼ�������
//user
	...
	public static final String SELECT_USER_STUDENT = "SELECT * FROM user ";
