...
-->
		...
		tiSum=tiSum-sum;
		List<Select> collection =(List)bf.ListSelect(submit_page,"where timu_id not in ("+str+") and diff>1 and diff<4 limit "+tiSum);
  ...
  <tr>
    <td height="48">&nbsp;当前无试题信息</td>
		...
		List<Blank> collection_b =(List)bf.ListBlank(submit_page,"where id not in ("+str_b+")  limit "+tiSum_b);
